...
class CalculadoraParlante:
    def __init__(self):
        self.engine = pyttsx3.init()  # Inicializar el motor de texto a voz
        self.voices = self.engine.getProperty('voices')
        self.engine.setProperty('voice', self.voices[3].id)  # Establecer la voz predeterminada
